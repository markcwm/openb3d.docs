...
EntityColor TheBox,200,50,50

Global TheSphere:TMesh = CreateSphere(16)
PositionEntity(TheSphere, -10, 0 ,0)
EntityColor TheSphere,50,200,100

' Initializes the 3D sound system. Sets camera as the listen point with sound heard up to 200 units away.
